...
- <a name="todo"></a> Decentralized Dynamic Cooperation of Personalized Models for Federated Continual Learning (**NeurIPS 2025**) [[paper](https://arxiv.org/abs/2509.23683)][[code](https://github.com/ydn3229/DCFCL)]
- <a name="todo"></a> Train with Perturbation, Infer after Merging: A Two-Stage Framework for Continual Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/543d064c7918f2987427ea877598d5eeab2eeb16.pdf)][[code](https://github.com/qhmiao/P-M-for-Continual-Learning)]
- <a name="todo"></a> MemEIC: A Step Toward Continual and Compositional Knowledge Editing (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/e5209240370185240edeb5bc9a5296481fd5702b.pdf)][[code](https://github.com/MemEIC/MemEIC)]
- <a name="todo"></a> C-NAV: Towards Self-Evolving Continual Object Navigation in Open World (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/4ac4cb06f6085be0e1f670ec7a2d405400da20e8.pdf)][[code](https://bigtree765.github.io/C-Nav-project)]
- <a name="todo"></a> Hybrid Re-matching for Continual Learning with Parameter-Efficient Tuning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/349f90fc9836bf298a245341e8a9674d35933d4a.pdf)][[code](https://github.com/wei-cheng777/HRM-PET)]
- <a name="todo"></a> A Minimalistic Unified Framework for Incremental Learning across Image Restoration Tasks (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/13e99d7ed18b26efa7b85826e1e8a99df5c73f39.pdf)]
- <a name="todo"></a> REP: Resource-Efficient Prompting for Rehearsal-Free Continual Learning (**NeurIPS 2025**) [[paper](https://arxiv.org/abs/2406.04772)]
- <a name="todo"></a> Learning Multi-Source and Robust Representations for Continual Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/4fb5e1c944bb7f5a7bbd0940acd385632ffe1643.pdf)][[code](https://github.com/CL-Coder236/LMSRR)]
- <a name="todo"></a> Learning Expandable and Adaptable Representations for Continual Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/4fb5563e95e97635d60d106826d8282c9446ac3a.pdf)][[code](https://github.com/yrluestc/NeurIPS2025-LEAR)]
- <a name="todo"></a> Dynamic Siamese Expansion Framework for Improving Robustness in Online Continual Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/67da68b3b329b0202146a83d07fb0d15ff233462.pdf)]
- <a name="todo"></a> Investigating and Mitigating Catastrophic Forgetting in Medical Knowledge Injection through Internal Knowledge Augmentation Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/f58613387e653de73eedc61bbe68e42c49e50e9b.pdf)][[code](https://github.com/THUMLP/InternAL)]
- <a name="todo"></a> C2Prompt: Class-aware Client Knowledge Interaction for Federated Continual Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/f8b45261958643144e6e7e3f1a61d4363528d66e.pdf)]
- <a name="todo"></a> Bisecle: Binding and Separation in Continual Learning for Video Language Understanding (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/801fcac64a080b370564e842cd4b56a2e8974a22.pdf)]
- <a name="todo"></a> Mixture of Noise for Pre-Trained Model-Based Class-Incremental Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/1829b253cee0041479734f7e7e9b92d4d7e1d695.pdf)][[code](https://github.com/ASCIIJK/MiN-NeurIPS2025)]
- <a name="todo"></a> Continual Multimodal Contrastive Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/69cbc69bcea23845cc672a33eaf78a0dcec49445.pdf)][[code](https://github.com/Xiaohao-Liu/CMCL)]
- <a name="todo"></a> Class-wise Balancing Data Replay for Federated Class-Incremental Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/ec65caf9fe04f4c9c2a17254738ed41f4bbd3198.pdf)]
- <a name="todo"></a> Model Inversion with Layer-Specific Modeling and Alignment for Data-Free Continual Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/b975219011d2f075274117ad71ea11352dc3b191.pdf)][[code](https://github.com/RuilinTong/PMI-CFS-DFCL)]
- <a name="todo"></a> Separating the 'what' and 'how' of compositional computation to enable reuse and continual learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/fdb14e926e8a7bc63dc6db85178caf66f98cf44d.pdf)]
- <a name="todo"></a> Demystifying Language Model Forgetting with Low-rank Example Associations (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/067610017dd177dfa6a1029074e8116d3570ba5f.pdf)]
- <a name="todo"></a> Resource-Constrained Federated Continual Learning: What Does Matter? (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/f8557516336a019b4b114aeddaf9d39856f2eca5.pdf)]
- <a name="todo"></a> GraphKeeper: Graph Domain-Incremental Learning via Knowledge Disentanglement and Preservation (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/9fd94742f39fa8cd5d8eefb6f60d0b9850957d30.pdf)]
- <a name="todo"></a> Turning the Tables: Enabling Backward Transfer via Causal-Aware LoRA in Continual Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/e9a25c29e826baac254646ad60582c54bfae9652.pdf)]
- <a name="todo"></a> Mitigating Intra- and Inter-modal Forgetting in Continual Learning of Unified Multimodal Models (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/5ad880771d74330c927c6033c68c49e31e0d5ae9.pdf)][[code](https://github.com/Christina200/MoDE-official)]
- <a name="todo"></a> AnaCP: Toward Upper-Bound Continual Learning via Analytic Contrastive Projection (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/5f7817e73992ea4b87d797fe310219351e339b88.pdf)]
- <a name="todo"></a> Contrastive Consolidation of Top-Down Modulations Achieves Sparsely Supervised Continual Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/3faaa4bb0b3b530c2d35bb826337052d61b3957c.pdf)]
- <a name="todo"></a> Gradient-Guided Epsilon Constraint Method for Online Continual Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/1387b8a57bb59dd6da0da9e3e58fcaa3730849db.pdf)]
- <a name="todo"></a> Temporal-Difference Variational Continual Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/0d68f72689fd19a0d802e8bba197b32483cd270f.pdf)]
- <a name="todo"></a> Confusion-Driven Self-Supervised Progressively Weighted Ensemble Learning for Non-Exemplar Class Incremental Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/627d26399f897c65964bd3726e13ff95ba2bb19c.pdf)]
- <a name="todo"></a> Exploiting Task Relationships in Continual Learning via Transferability-Aware Task Embeddings (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/dfee6dd4b16286238df709c41b13d39bd2200db9.pdf)][[code](https://github.com/viki760/H-embedding-Guided-Hypernet)]
- <a name="todo"></a> MEMOIR: Lifelong Model Editing with Minimal Overwrite and Informed Retention for LLMs (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/5d7652bd81dac5caf264059bf95575f2c88415e9.pdf)]
- <a name="todo"></a> Self-Evolving Pseudo-Rehearsal for Catastrophic Forgetting with Task Similarity in LLMs (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/02bb9435749398313a19d1e2d4389699ebe7d3bf.pdf)][[code](https://github.com/JerryWangJun/LLM_CL_SERS/)]
- <a name="todo"></a> Continual Gaussian Mixture Distribution Modeling for Class Incremental Semantic Segmentation (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/edeacdd30441529e3a7cdfb01bd04f546acde90b.pdf)]
- <a name="todo"></a> Continuous Subspace Optimization for Continual Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/c71157439fbefdeda28eb60a1edc10bd029fcaba.pdf)]
- <a name="todo"></a> Dual-Space Semantic Synergy Distillation for Continual Learning of Unlabeled Streams (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/ce226da4c2fa8145503bb97f96f731336b26d0b5.pdf)]
- <a name="todo"></a> Class-wise Balancing Data Replay for Federated Class-Incremental Learning (**NeurIPS 2025**) [[paper](https://arxiv.org/abs/2507.07712)]
- <a name="todo"></a> Continual Knowledge Adaptation for Reinforcement Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/c72391e754ba2504b859d1c0d6306f6865f0a24c.pdf)][[code](https://github.com/Fhujinwu/CKA-RL)]
- <a name="todo"></a> Learn and Ensemble Bridge Adapters for Multi-domain Task Incremental Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/3b321697d2f0a69e9fa0df4c895c73ea08551d06.pdf)]
- <a name="todo"></a> Merging on the Fly Without Retraining: A Sequential Approach to Scalable Continual Model Merging (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/56abd1b9e44f24af3bcebd2180eeda7e45eb5cd2.pdf)][[code](https://github.com/tanganke/opcm)]
- <a name="todo"></a> Federated Continual Learning via Orchestrating Multi-Scale Expertise (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/01d10925a72bb821331414e409375df3321f1a13.pdf)]
- <a name="todo"></a> Reliable Lifelong Multimodal Editing: Conflict-Aware Retrieval Meets Multi-Level Guidance (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/e9c3d5a5e890cfc52d58bb0f8c853abe590119fe.pdf)]
- <a name="todo"></a> Evolving and Regularizing Meta-Environment Learner for Fine-Grained Few-Shot Class-Incremental Learning (**NeurIPS 2025**) [[paper](https://openreview.net/pdf?id=AU2eaY2QEu)]
- <a name="todo"></a> Diffusion-Classifier Synergy: Reward-Aligned Learning via Mutual Boosting Loop for FSCIL (**NeurIPS 2025**) [[paper](https://openreview.net/pdf/8df38ae309d23129b6ef1a2f74d4ea8883740cf0.pdf)]
- <a name="todo"></a> Continual Model Merging without Data: Dual Projections for Balancing Stability and Plasticity (**NeurIPS 2025**) [[paper](https://openreview.net/pdf?id=zD5cUX67b9)]
...
- <a name="todo"></a> FG-OrIU: Towards Better Forgetting via Feature-Gradient Orthogonality for Incremental Unlearning (**ICCV 2025**) [[paper](https://openaccess.thecvf.com/content/ICCV2025/papers/Feng_FG-OrIU_Towards_Better_Forgetting_via_Feature-Gradient_Orthogonality_for_Incremental_Unlearning_ICCV_2025_paper.pdf)][[code](https://github.com/RAIAN08/FG-OrIU)]
...
- <a name="todo"></a> DMNSP: Dynamic Multi-Layer Null Space Projection for Vision-Language Continual Learning (**ICCV 2025**) [[paper](https://openaccess.thecvf.com/content/ICCV2025/papers/Kang_Dynamic_Multi-Layer_Null_Space_Projection_for_Vision-Language_Continual_Learning_ICCV_2025_paper.pdf)][[code](https://github.com/RL-VIG/DMNSP)]
...
- <a name="todo"></a> Dual Domain Control via Active Learning for Remote Sensing Domain Incremental Object Detection (**ICCV 2025**) [[paper](https://openaccess.thecvf.com/content/ICCV2025/papers/Sun_Dual_Domain_Control_via_Active_Learning_for_Remote_Sensing_Domain_ICCV_2025_paper.pdf)]
- <a name="todo"></a> Feature Decomposition-Recomposition in Large Vision-Language Model for Few-Shot Class-Incremental Learning (**ICCV 2025**) [[paper](https://openaccess.thecvf.com/content/ICCV2025/papers/Xue_Feature_Decomposition-Recomposition_in_Large_Vision-Language_Model_for_Few-Shot_Class-Incremental_Learning_ICCV_2025_paper.pdf)]
- <a name="todo"></a> Seeing 3D Through 2D Lenses: 3D Few-Shot Class-Incremental Learning via Cross-Modal Geometric Rectification (**ICCV 2025**) [[paper](https://openaccess.thecvf.com/content/ICCV2025/papers/Xiang_Seeing_3D_Through_2D_Lenses_3D_Few-Shot_Class-Incremental_Learning_via_ICCV_2025_paper.pdf)]
- <a name="todo"></a> PLAN: Proactive Low-Rank Allocation for Continual Learning (**ICCV 2025**) [[paper](https://openaccess.thecvf.com/content/ICCV2025/papers/Wang_PLAN_Proactive_Low-Rank_Allocation_for_Continual_Learning_ICCV_2025_paper.pdf)]
- <a name="todo"></a> Overcoming Dual Drift for Continual Long-Tailed Visual Question Answering (**ICCV 2025**) [[paper](https://openaccess.thecvf.com/content/ICCV2025/papers/Zhang_Overcoming_Dual_Drift_for_Continual_Long-Tailed_Visual_Question_Answering_ICCV_2025_paper.pdf)]
- <a name="todo"></a> Continual Personalization for Diffusion Models (**ICCV 2025**) [[paper](https://openaccess.thecvf.com/content/ICCV2025/papers/Liao_Continual_Personalization_for_Diffusion_Models_ICCV_2025_paper.pdf)]
...
- <a name="todo"></a> Lark: Low-Rank Updates After Knowledge Localization for Few-shot Class-Incremental Learning (**ICCV 2025**) [[paper](https://openaccess.thecvf.com/content/ICCV2025/papers/Shi_Lark_Low-Rank_Updates_After_Knowledge_Localization_for_Few-shot_Class-Incremental_Learning_ICCV_2025_paper.pdf)]
- <a name="todo"></a> CoSMIC: Continual Self-supervised Learning for Multi-Domain Medical Imaging via Conditional Mutual Information Maximization (**ICCV 2025**) [[paper](https://openaccess.thecvf.com/content/ICCV2025/papers/Liu_CoSMIC_Continual_Self-supervised_Learning_for_Multi-Domain_Medical_Imaging_via_Conditional_ICCV_2025_paper.pdf)]
- <a name="todo"></a> Flexi-FSCIL: Adaptive Knowledge Retention for Breaking the Stability-Plasticity Dilemma in Few-Shot Class-Incremental Learning (**ICCV 2025**) [[paper](https://openaccess.thecvf.com/content/ICCV2025/papers/Xie_Flexi-FSCIL_Adaptive_Knowledge_Retention_for_Breaking_the_Stability-Plasticity_Dilemma_in_ICCV_2025_paper.pdf)]
- <a name="todo"></a> Generalization-Preserved Learning: Closing the Backdoor to Catastrophic Forgetting in Continual Deepfake Detection (**ICCV 2025**) [[paper](https://openaccess.thecvf.com/content/ICCV2025/papers/Zhang_Generalization-Preserved_Learning_Closing_the_Backdoor_to_Catastrophic_Forgetting_in_Continual_ICCV_2025_paper.pdf)]
- <a name="todo"></a> A Tiny Change, A Giant Leap: Long-Tailed Class-Incremental Learning via Geometric Prototype Alignment (**ICCV 2025**) [[paper](https://openaccess.thecvf.com/content/ICCV2025/papers/Lai_A_Tiny_Change_A_Giant_Leap_Long-Tailed_Class-Incremental_Learning_via_ICCV_2025_paper.pdf)]
...
- <a name="todo"></a> ZeroFlow: Overcoming Catastrophic Forgetting is Easier than You Think (**ICML 2025**) [[paper](https://arxiv.org/pdf/2501.01045)]
...
- <a name="todo"></a> CL-LoRA: Continual Low-Rank Adaptation for Rehearsal-Free Class-Incremental Learning (**CVPR 2025**) [[paper](https://arxiv.org/abs/2505.24816)][[code](https://github.com/JiangpengHe/CL-LoRA)]
...
- <a name="todo"></a> ConceptGuard: Continual Personalized Text-to-Image Generation with Forgetting and Confusion Mitigation (**CVPR 2025**) [[paper](http://arxiv.org/abs/2503.10358)]
